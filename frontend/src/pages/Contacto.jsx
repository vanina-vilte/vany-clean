...
function Contacto() {
  usePageMeta(
    'Contacto | Solicitá tu Presupuesto de Limpieza - Vany Clean',
    'Contactate con Vany Clean para solicitar un presupuesto sin cargo. Atendemos CABA y alrededores. Teléfono, email y WhatsApp disponibles.'
  )
